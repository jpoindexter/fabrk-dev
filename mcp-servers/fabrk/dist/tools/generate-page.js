 ...
 */
export function generatePage(args) {
...
function generateLandingPage(name, sections) {
...
function generateDashboardPage(name, sections) {
...
function generateSettingsPage(name) {
...
function generateAuthPage(name) {
...
function generateDocsPage(name) {
...
function generateGenericPage(name) {
    return `// ${name} Page
import { cn } from '@/lib/utils';
import { mode } from '@/design-system';
