...
// AvatarFallback
cn("bg-muted flex h-full w-full items-center justify-center text-xs font-medium", mode.radius, mode.font)
```
...
<div className="relative">
  ...
  <span className="absolute -bottom-1 -right-1 h-3 w-3 bg-success border-2 border-background" />
</div>
```
...
*Avatar Component Specification v1.0.0*
