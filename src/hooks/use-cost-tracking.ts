/**
 * React Hooks for AI Cost Tracking
 *
 * Display real-time AI spending in your components.
 *
 * @example
 * function CostWidget() {
 *   const { todaysCost, budget, withinBudget } = useCostTracking()
 *   return <div>${todaysCost.toFixed(2)} / ${budget}</div>
 * }
 */
