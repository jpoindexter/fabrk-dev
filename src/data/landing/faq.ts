...
export const FAQ_QUESTIONS = [
  {
    ...
    answer:
      "Fabrk is a production-ready Next.js 15 SaaS boilerplate with 234 components, authentication, billing, multi-tenancy, and a unique terminal-inspired design system. It's designed to help you ship your SaaS in days, not months.",
  },
  {
    id: 'license',
