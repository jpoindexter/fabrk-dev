...
describe("Security Validation", () => {
  ...
  describe("Validation Schemas", () => {
    it("should validate email", () => {
      expect(ValidationSchemas.email.safeParse("test@example.com").success).toBe(
        true
      );
    ...
    it("should validate password strength", () => {
      ...
      expect(ValidationSchemas.password.safeParse("nouppercaseornumber").success).toBe(
        false
      );
    });

    it("should validate URLs", () => {
      expect(ValidationSchemas.url.safeParse("https://example.com").success).toBe(
        true
      );
