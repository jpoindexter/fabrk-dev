...
>
  ...
  <p className="text-muted-foreground text-sm">Introduction text...</p>
</motion.div>
```
  ...
  <table className="w-full text-xs">
    <thead>
      <tr className="border-border border-b">
        <th className="text-muted-foreground py-2 pr-4 text-left">COLUMN</th>
      </tr>
    </thead>
    <tbody className="text-muted-foreground">
      <tr className="border-border/50 border-b">
        <td className="text-foreground py-2 pr-4">Value</td>
      </tr>
    </tbody>
  </table>
</div>
...
```tsx
<section className="border-destructive/30 bg-destructive/5 border p-6">
