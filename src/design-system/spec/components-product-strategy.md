...
_The components that sell the boilerplate._
...
_Move to experimental section or hide from main showcase._
...
_Highest-impact missing components._
...
**High Value (Differentiators):** 4. **SettingsLayout** - Settings sidebar + content 5. **LineChart** - Time series trends 6. **BarChart** - Comparison charts 7. **AreaChart** - Volume/cumulative data 8. **BillingSummaryCard** - Usage and billing display 9. **PlanSelector** - Pricing tier selection

**Nice to Have:** 10. **UsageMeter** - Usage-based billing display 11. **FiltersBar** - Table filtering toolbar

---

## 1. High-Value Core Set

_Components that are critical or high market value, theme-friendly, and ready to ship._
...
_Components that add value but aren't critical for the core offering._
...
_Components to move to an "Extras" section or hide from main showcase._
...
_Without these, the boilerplate feels incomplete compared to paid alternatives._
...
_These make the boilerplate stand out in feature comparisons and demo videos._
...
_Polish items that make the boilerplate feel premium but aren't blocking._
...
_Generated as part of Component Value Audit. See `design-system/audit/COMPONENT_VALUE_AUDIT.md` for methodology._
