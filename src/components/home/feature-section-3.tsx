      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row gap-12 md:gap-16 items-center">
        <div className="flex flex-col gap-8 flex-1">
          <div className="flex flex-col gap-4 md:gap-5">
            ...
            <p className="text-base text-muted-foreground">In just 3 simple steps, you're ready to go:</p>
          </div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="flex flex-col sm:flex-row gap-4 sm:gap-5">
                  <div className="flex justify-center items-center w-10 h-10 shrink-0 rounded-md bg-background border-primary/20 border shadow-sm">
        ...
        <div className="flex-1 w-full">
          <div className="overflow-hidden rounded-xl border-primary/20 border bg-background shadow-xl">
