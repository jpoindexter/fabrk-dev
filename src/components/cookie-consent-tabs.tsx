  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="flex items-center justify-between rounded-brutal border-2 border-foreground bg-muted p-4">
        ...
        <div className="flex items-center justify-between rounded-brutal border-2 border-foreground p-4">
          <div className="flex-1">
        ...
        <div className="flex items-center justify-between rounded-brutal border-2 border-foreground p-4">
          <div className="flex-1">
            <h4 className="font-semibold">Statistics Cookies</h4>
            <p className="mt-1 text-sm text-muted-foreground">
        ...
        <div key={category.id} className="space-y-3">
          ...
          <div className="ml-6 space-y-2">
            {category.cookies.map((cookie) => (
              <div key={cookie.name} className="rounded-brutal border-2 border-foreground bg-muted p-3 text-sm">
                <div className="flex items-center justify-between">
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="rounded-brutal border-2 border-foreground bg-primary/10 p-4">
