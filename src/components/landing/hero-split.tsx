      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className={`${contentOrder} flex flex-col justify-center`}>
            {/* Early Access Badge */}
            <div className="mb-6">
              <div className="inline-block rounded-full bg-[#007AFF]/10 px-4 py-1.5">
            ...
            {/* Headline */}
            <h1 className="mb-6 text-4xl font-bold leading-[1.1] tracking-tight text-black sm:text-5xl md:text-6xl">
              {headline}
            </h1>

            {/* Subheadline */}
            <p className="mb-8 text-lg leading-relaxed text-[#333333] sm:text-xl">
              {subheadline}
            </p>
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 border-2 border-black px-8 text-lg font-semibold text-black transition-all hover:bg-black hover:text-white"
                asChild
              >
            ...
            <div className="flex flex-wrap gap-3">
              {trustBadges.map((badge) => (
                <div
                  key={badge}
                  className="rounded-md border-2 border-black bg-white px-3 py-1.5 text-sm font-semibold text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                >
                  {badge}
                </div>
              ))}
          ...
          <div className={`${imageOrder} relative`}>
            <div className="relative rounded-lg border-4 border-black bg-[#EEEEEE] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              {/* Dashboard Mockup */}
                ...
                <div className="h-full w-full rounded border-2 border-black/10 bg-white p-4">
                  ...
                  <div className="mb-4 flex items-center justify-between border-b-2 border-black/10 pb-3">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full border-2 border-black bg-[#007AFF]"></div>
                      <div>
                        <div className="h-3 w-24 rounded bg-black/20"></div>
                        <div className="mt-1 h-2 w-16 rounded bg-black/10"></div>
                      </div>
                    </div>
                    <div className="h-8 w-8 rounded border-2 border-black bg-[#EEEEEE]"></div>
                  </div>
                  ...
                  <div className="mb-4 grid grid-cols-3 gap-3">
                    {[1, 2, 3].map((i) => (
                      ...
                      >
                        ...
                        <div className="h-4 w-8 rounded bg-[#007AFF]/20"></div>
                      </div>
                    ))}
                  </div>
              ...
              {/* File Count Badge */}
              <div className="absolute -bottom-4 -right-4 rounded-full border-4 border-black bg-[#007AFF] px-6 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <p className="text-sm font-bold text-white">161 Files</p>
              </div>
            </div>

            {/* Decorative Elements */}
            <div className="absolute -left-8 top-8 -z-10 h-32 w-32 rounded-full bg-[#007AFF]/10"></div>
