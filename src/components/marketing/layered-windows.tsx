...
export function LayeredWindows() {
  return (
    <div className="relative grid min-h-[600px] w-full grid-cols-2 gap-8">
      {/* Left Column - Main Window with Hero Content */}
      <motion.div
        ...
        style={{ zIndex: 1 }}
      >
        <div className={cn('h-full border', mode.color.border.default, mode.color.bg.surface)}>
      ...
      {/* Right Column - Cascading Small Windows (diagonal left-to-right, top-to-bottom) */}
      <div className="relative">
        {/* Small Window 1 - Value Metrics (top-left) */}
        <motion.div
        ...
        {/* Small Window 2 - Progress Bars (middle) */}
        <motion.div
          initial={{ opacity: 0, x: 0, y: 0 }}
          animate={{ opacity: 1, x: 60, y: 100 }}
        ...
        {/* Small Window 3 - Main Pricing (bottom-right) */}
        <motion.div
          initial={{ opacity: 0, x: 30, y: 0 }}
