...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "border-input relative flex h-8 w-8 items-center justify-center border-y border-r font-mono text-xs transition-all first:rounded-none first:border-l last:rounded-none",
