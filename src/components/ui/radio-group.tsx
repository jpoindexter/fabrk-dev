...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ref={ref}
      className={cn(
        "aspect-square h-5 w-5 rounded-full border-3 border-black dark:border-white shadow-brutal-sm text-primary ring-offset-background transition-all duration-150 ease-out",
