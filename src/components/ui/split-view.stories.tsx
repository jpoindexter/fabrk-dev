  ...
  render: () => (
    <div style={{ height: "400px" }}>
      <SplitViewCustom sizes={[1, 2, 1, 3]} gap={12}>
        ...
        <div className="h-full p-4 bg-muted border-brutal rounded-brutal">
          ...
          <div className="h-full border-brutal rounded-brutal bg-background">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 border-brutal rounded-brutal">
  ...
  render: () => (
    <div style={{ height: "600px" }}>
      <SidebarLayout
            ...
            <div className="p-6">
              <div className="grid grid-cols-3 gap-4 mb-6">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={i}
                    className="p-4 border-brutal rounded-brutal"
                  >
              ...
              <div className="space-y-4">
                <div className="p-6 border-brutal rounded-brutal">
                  <h3 className="font-bold mb-4">Recent Activity</h3>
                  <div className="space-y-2">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <div
                        key={i}
                        className="p-3 border-brutal rounded-brutal"
                      >
        ...
        footer={
          <div className="h-full border-brutal rounded-brutal bg-card flex items-center justify-between px-4">
            <p className="text-sm text-muted-foreground">
              © 2025 Your Company
            </p>
  ...
  render: () => (
    <div style={{ height: "600px" }}>
      <SplitViewThreePanel ratios={[20, 35, 45]} gap={8}>
        <div className="h-full border-brutal rounded-brutal bg-card p-3">
