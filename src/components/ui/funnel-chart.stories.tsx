...
export const SalesFunnel: Story = {
  render: () => (
    <div className="w-[700px] p-6 rounded-md border bg-card">
      <h3 className="font-semibold text-center mb-6">E-commerce Sales Funnel</h3>
...
export const LeadGeneration: Story = {
  render: () => (
    <div className="w-[700px] p-6 rounded-md border bg-card">
      <h3 className="font-semibold text-center mb-6">B2B Lead Generation Funnel</h3>
      ...
      <div className="mt-6 pt-4 border-t">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">16.7%</p>
          </div>
          <div>
...
export const SmallFunnel: Story = {
  render: () => (
    <div className="w-[400px] p-4 rounded-md border bg-card">
      <h3 className="font-semibold text-sm text-center mb-4">Checkout Flow</h3>
      <FunnelChart
        data={[
