    ...
    return (
      <div className="w-[600px] space-y-4">
        <div className="space-y-2">
          ...
          <div className="rounded-brutal border-2 border-brutal bg-muted p-3 text-sm space-y-1 min-h-[100px]">
            {logs.length === 0 ? (
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 text-sm rounded-brutal border-2 border-brutal bg-primary text-primary-foreground hover:bg-primary/90"
            >
              Expand All
            </button>
            <button
              onClick={() => setExpandedIds([])}
              className="px-3 py-1 text-sm rounded-brutal border-2 border-brutal bg-secondary text-secondary-foreground hover:bg-secondary/90"
            >
              Collapse All
            </button>
            <button
              onClick={() => setSelectedIds([])}
              className="px-3 py-1 text-sm rounded-brutal border-2 border-brutal bg-destructive text-destructive-foreground hover:bg-destructive/90"
            >
              Clear Selection
            </button>
          </div>
