/**
 * ✅ FABRK COMPONENT
 * A component for building complex forms.
 *
 * @example
 * ```tsx
 * <field>Content</field>
...
function FieldControl({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="field-control" className={cn("flex-1", className)} {...props} />;
}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "font-mono text-xs font-normal leading-normal text-muted-foreground group-has-[[data-orientation=horizontal]]/field:text-balance",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("font-mono text-xs font-normal text-destructive", className)}
      {...props}
    >
      {content}
    </div>
