...
import { ArrowRight, Bell, Check, Download, Heart, Mail, MoreHorizontal, Search, Settings, Trash2, Upload, User, UserCog, X } from "lucide-react";
        ...
        <section id="dropdown-menus" className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Contextual menus with proper alignment patterns.{" "}
              <Link href="/docs/DROPDOWN-ALIGNMENT-GUIDE.md" className="text-primary hover:underline">
                View alignment guide →
              </Link>
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                For right-side triggers: table actions, navbar menus, card actions
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-4">
                Menu aligns to the right edge of the trigger to prevent overflow at the viewport edge
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                For left-side triggers: sidebar menus, left-positioned actions
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-4">
                Menu aligns to the left edge of the trigger for left-positioned controls
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Icon & Spacing Standards</CardTitle>
              <CardDescription>
                Standard icon sizing (h-4 w-4) with mr-2 spacing
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex justify-center">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-48">
                    <DropdownMenuLabel>Standard Icons</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="font-semibold">
              ...
              <div className="mt-4 p-3 bg-muted rounded-md text-sm space-y-1">
                ...
                <ul className="text-xs text-muted-foreground space-y-1 ml-4">
                  <li>• Icons: <code className="text-xs">h-4 w-4</code> (16px)</li>
                  <li>• Spacing: <code className="text-xs">mr-2</code> (8px gap)</li>
                  <li>• Font: <code className="text-xs">font-semibold</code> for emphasis</li>
                  <li>• Destructive: <code className="text-xs">text-destructive</code> class</li>
                </ul>
              </div>
            </CardContent>
          </Card>
