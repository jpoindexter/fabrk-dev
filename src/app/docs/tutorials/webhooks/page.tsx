  ...
  return (
    <div className="space-y-16">
      ...
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">AVAILABLE_WEBHOOK_EVENTS</h2>
        <div>
          <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
security.password_changed  // Password changed`} />
      ...
      {/* Triggering Webhooks */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">TRIGGERING_WEBHOOKS</h2>
        <div>
          <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
await triggerWebhook(
  ...
  WEBHOOK_EVENTS.PAYMENT_SUCCEEDED,
  {
    ...
    status: "succeeded"
      ...
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">HMAC_SHA256_VERIFICATION</h2>
        <div>
          <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
export async function POST(request: Request) {
  ...
  return new Response("OK", { status: 200 });
      ...
      {/* Webhook Headers */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">WEBHOOK_HEADERS</h2>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
      ...
      {/* Payload Structure */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">PAYLOAD_STRUCTURE</h2>
        <div>
          <p className="font-mono text-sm text-muted-foreground leading-relaxed">
  ...
  "timestamp": "2024-01-15T10:30:00.000Z"
      ...
      {/* Retry Logic */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">AUTOMATIC_RETRY_LOGIC</h2>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
      ...
      {/* Testing Webhooks */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">TESTING_WEBHOOKS</h2>
        <div>
          <p className="font-mono text-sm text-muted-foreground leading-relaxed">
