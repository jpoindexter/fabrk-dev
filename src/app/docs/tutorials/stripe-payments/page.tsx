    ...
    <div className="space-y-16">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">CONFIGURE_STRIPE</h2>
        </div>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
STRIPE_WEBHOOK_SECRET="whsec_..."`} />
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">CREATE_A_PRODUCT</h2>
        </div>
...
NEXT_PUBLIC_STRIPE_PRICE_FABRK="price_your_price_id"`} />
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">CREATE_CHECKOUT_BUTTON</h2>
        </div>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
    ...
    <Button onClick={handleCheckout} disabled={loading}>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">SET_UP_WEBHOOKS</h2>
        </div>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
stripe listen --forward-to localhost:3000/api/webhooks/stripe`} />
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">HANDLE_WEBHOOK_EVENTS</h2>
        </div>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-lg font-bold text-primary">PROMOTION_CODES</h2>
        </div>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
...
stripe: {
  coupons: {
    earlyAdopter: {
      ...
      {/* Test Cards */}
      <div className="space-y-4">
        <h2 className="font-mono text-lg font-bold text-primary">TEST_CARDS</h2>
        <p className="font-mono text-sm text-muted-foreground leading-relaxed">
