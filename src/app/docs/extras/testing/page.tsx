  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Available test commands:</p>
  ...
  it("applies variant classes correctly", () => {
    ...
    expect(screen.getByRole("button")).toHaveClass("bg-destructive");
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Example hook test with timer mocking:</p>
        <div className="[&>div]:rounded-none">
  ...
  it("debounces value changes", () => {
    ...
    expect(result.current).toBe("updated");
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Test API endpoints with mocked dependencies:</p>
        <div className="[&>div]:rounded-none">
  ...
  test("shows error for invalid credentials", async ({ page }) => {
    ...
    await expect(page.locator(".text-destructive")).toBeVisible();
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Configure Playwright for E2E testing:</p>
        <div className="[&>div]:rounded-none">
  ...
  webServer: {
    ...
    reuseExistingServer: !process.env.CI,
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Test for accessibility violations:</p>
        <div className="[&>div]:rounded-none">
  ...
  test("dashboard has no a11y violations", async ({ page }) => {
    ...
    expect(results.violations).toEqual([]);
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">Configure test environment and mocks:</p>
        <div className="[&>div]:rounded-none">
...
process.env.NEXTAUTH_SECRET = "test-secret-at-least-32-characters";`} />
      ...
      <div className="space-y-3">
        ...
        <p className="font-mono text-base text-muted-foreground">GitHub Actions workflow for automated testing:</p>
        <div className="[&>div]:rounded-none">
