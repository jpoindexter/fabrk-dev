  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight">Cookie Consent</h1>
      ...
      <Card>
        <CardContent className="p-6 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <h3 className="font-medium">Google Requirements</h3>
              <ul className="list-inside list-disc space-y-1 text-sm text-muted-foreground">
...
if (daysSinceConsent < 365) {  // Change 365 to your desired days
  return { preferences: JSON.parse(consent), showButton: false };
      ...
      {/* Data Export Feature */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold">Data Export (GDPR Right to Access)</h2>
        <p className="text-muted-foreground">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <ul className="list-inside list-disc space-y-1 text-sm text-muted-foreground">
              ...
              <li>Request goes to <code className="rounded bg-muted px-1">/api/user/export</code></li>
        ...
        <Card>
          <CardContent className="p-6 space-y-4">
            ...
            <ol className="list-inside list-decimal space-y-2 text-sm text-muted-foreground">
              ...
              <li>Open DevTools → Application → Local Storage → look for <code className="rounded bg-muted px-1">cookie-consent</code></li>
            </ol>

            <h3 className="font-semibold mt-4">Verify GTM Integration</h3>
            <ol className="list-inside list-decimal space-y-2 text-sm text-muted-foreground">
              <li>Open DevTools → Console</li>
              <li>Type <code className="rounded bg-muted px-1">dataLayer</code> and press Enter</li>
              <li>Look for <code className="rounded bg-muted px-1">cookie_consent_update</code> events</li>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <details className="rounded-lg border">
            ...
            <div className="border-t p-4 text-sm text-muted-foreground">
              <p>
                Yes! In <code className="rounded bg-muted px-1">cookie-consent.tsx</code>, find the button element and change the
                Tailwind classes. It&apos;s currently <code className="rounded bg-muted px-1">bottom-6 right-6</code>. Change to
                <code className="rounded bg-muted px-1">bottom-6 left-6</code> for bottom-left, etc.
              </p>
            </div>
          </details>
