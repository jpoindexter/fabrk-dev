    ...
    <div className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="fullname" className="rounded-none font-mono text-xs">
                  [FULL_NAME]:
                </Label>
                <Input
                  id="fullname"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="rounded-none font-mono text-xs">
                  [EMAIL]:
                </Label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="company" className="rounded-none font-mono text-xs">
                  [COMPANY]:
                </Label>
                <Input
                  id="company"
              ...
              <div className="space-y-2">
                <Label htmlFor="jobtitle" className="rounded-none font-mono text-xs">
                  [JOB_TITLE]:
                </Label>
                <Input
                  id="jobtitle"
            ...
            <div className="space-y-2">
              <Label htmlFor="bio" className="rounded-none font-mono text-xs">
                [BIO]:
              </Label>
              <Textarea
                id="bio"
      ...
      <CodeWindow filename="security.config">
        <div className="p-4">
          ...
          />
          <div className="space-y-4">
            <div className="border-border flex items-center justify-between border p-4 font-mono text-xs">
              <div>
                <div>[PASSWORD]:</div>
                <div className="text-muted-foreground">Last changed 3 months ago</div>
              </div>
              <Button variant="outline" className="w-24 rounded-none font-mono text-xs">
                &gt; CHANGE
              </Button>
            </div>
            <div className="border-border flex items-center justify-between border p-4 font-mono text-xs">
