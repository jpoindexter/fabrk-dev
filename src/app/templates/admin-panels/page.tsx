      ...
      <main className="container mx-auto max-w-7xl px-6 py-12 space-y-12">
        ...
        <section className="space-y-4">
          <div className="inline-block border border-border px-4 py-1">
            <span className="font-mono text-xs text-muted-foreground">[CATEGORY]: ADMIN_PANELS</span>
          </div>
        ...
        <div className="border border-border bg-card">
          ...
          <div className="p-6">
            <div className="mb-4 font-mono text-xs text-muted-foreground">[ADMIN_PANEL_TEMPLATES]:</div>
            <div className="space-y-2 font-mono text-xs">
              <div><span className="text-success">&gt;</span> User management with role-based access control</div>
              <div><span className="text-success">&gt;</span> Invitation system with 7-day token expiry</div>
              <div><span className="text-success">&gt;</span> Organization switcher with multi-tenancy support</div>
              <div><span className="text-success">&gt;</span> Audit logs and activity tracking</div>
              <div><span className="text-success">&gt;</span> Data tables with sorting, filtering, and pagination</div>
              <div><span className="text-success">&gt;</span> Webhook management and delivery history</div>
            </div>
          </div>
        </div>
      </main>
