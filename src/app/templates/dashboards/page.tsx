      ...
      <main className="container mx-auto max-w-7xl px-6 py-12 space-y-12">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          {categories.map((category) => (
            <Button
              key={category.id}
              variant={category.id === "dashboard" ? "default" : "outline"}
              asChild
              className="gap-2"
            >
              {category.href ? (
        ...
        <Card className="border border-primary/20 bg-primary/5">
          <CardContent className="pt-6">
            ...
            <ul className="space-y-1 text-sm text-muted-foreground">
              <li className="font-semibold">✓ Analytics Dashboard with charts and metrics</li>
              <li className="font-semibold">✓ Team Dashboard for collaboration and task tracking</li>
              <li className="font-semibold">✓ Billing Dashboard for subscription management</li>
              <li className="font-semibold">✓ Real-time data visualization and reporting</li>
              <li className="font-semibold">✓ Responsive grid layouts with tabbed sections</li>
              <li className="font-semibold">✓ Activity feeds and user interaction tracking</li>
            </ul>
          </CardContent>
        </Card>
      </main>
