      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground text-xl">
            Your purchase was successful. Check your email for download
            instructions.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  We've sent you a confirmation email with download links and
                  instructions. Check your spam folder if you don't see it
                  within 5 minutes.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Use the download link in your email to get the complete Fabrk
                  boilerplate (ZIP file). Extract it and follow the setup
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  to get started. Full documentation is included in the{' '}
                  <code className="bg-muted rounded px-2 py-1 text-xs">
                    docs/
                  </code>{' '}
                  folder.
        ...
        <div className="bg-muted/50 mb-8 rounded-none p-6">
          ...
          <p className="text-muted-foreground mb-4 text-sm">
            Check the comprehensive documentation included in your download, or
