 ...
 * Handles errors in public marketing pages and documentation
 * Provides user-friendly recovery with links to docs and home
 */
export default function MarketingError({
  ...
  useEffect(() => {
    ...
    //   tags: { section: 'marketing', route: window.location.pathname },
    // });
  }, [error]);
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        {/* Error Message */}
        <h1 className={cn('text-foreground mb-4 text-4xl font-semibold', mode.font)}>PAGE ERROR</h1>
        <p className={cn('text-muted-foreground mb-8 text-sm', mode.font)}>
          [ERROR]: This page encountered an unexpected error. Don't worry, this doesn't affect your
          account or data.
        </p>
