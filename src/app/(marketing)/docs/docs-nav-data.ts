  ...
  },
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        items: [
          { title: "API_KEY_MANAGER", href: "/docs/components/api-key-manager", icon: Key },
          { title: "AUDIT_LOG", href: "/docs/components/audit-log", icon: ScrollText },
          ...
          { title: "WEBHOOK_LOG", href: "/docs/components/webhook-log", icon: Webhook },
        ],
      },
      {
        title: "[07.L] LANDING",
