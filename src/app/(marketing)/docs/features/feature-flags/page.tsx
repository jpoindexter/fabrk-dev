    ...
    <FeatureGuideTemplate
      ...
      features={[
        ...
        },
        {
          ...
          description:
            'Roll out to a percentage of users for gradual releases.',
        },
        {
          icon: Users,
      ...
      <DocsSection title="Best Practices">
        <DocsCard title="BEST_PRACTICES">
          <ul className="space-y-1">
            ...
            <li>
              ├─ <strong>Start at 0%:</strong> Begin rollouts at 0% and
              gradually increase
            </li>
            <li>
              ├─ <strong>Add kill switches:</strong> Every major feature should
              have a flag
            </li>
            <li>
              ├─ <strong>Clean up old flags:</strong> Remove flags once features
              are fully rolled out
            </li>
            <li>
              ├─ <strong>Test both states:</strong> Ensure your app works with
              flag on and off
            </li>
            <li>
              ├─ <strong>Document flags:</strong> Keep a registry of active
              flags and their purpose
            </li>
            <li>
              └─ <strong>Use consistent hashing:</strong> Same user always gets
              same result for % rollouts
            </li>
          </ul>
        </DocsCard>
      </DocsSection>
