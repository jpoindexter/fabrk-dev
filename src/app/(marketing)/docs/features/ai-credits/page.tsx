      ...
      <DocsSection title="UI Components">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link href="/docs/components/balance-display">
            <DocsCard title="BALANCE" className="hover:border-primary/50 h-full transition-all">
          ...
          <Link href="/docs/components/usage-meter">
            <DocsCard title="METER" className="hover:border-primary/50 h-full transition-all">
              <p className="text-muted-foreground text-sm">
          ...
          <Link href="/docs/components/plan-selector">
            <DocsCard title="PLANS" className="hover:border-primary/50 h-full transition-all">
              <p className="text-muted-foreground text-sm">
          ...
          <Link href="/docs/components/credit-usage-chart">
            <DocsCard title="CHART" className="hover:border-primary/50 h-full transition-all">
              <p className="text-muted-foreground text-sm">
          ...
          <Link href="/docs/components/credit-transaction-table">
            <DocsCard title="HISTORY" className="hover:border-primary/50 h-full transition-all">
              <p className="text-muted-foreground text-sm">
