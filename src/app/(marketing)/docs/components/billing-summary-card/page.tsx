...
/>`,
      ...
      props={[
        ...
        { name: "currentPeriodEnd", type: "Date", description: "Current billing period end date." },
        { name: "trialEnd", type: "Date", description: "Trial end date (when status is trial)." },
        { name: "usage", type: "UsageItem[]", description: "Array of usage items to display." },
        { name: "onUpgrade", type: "() => void", description: "Upgrade button click handler." },
        {
          name: "onManageBilling",
          type: "() => void",
          description: "Manage billing click handler.",
        },
        { name: "onCancel", type: "() => void", description: "Cancel subscription click handler." },
        {
          name: "showUpgrade",
          type: "boolean",
          default: "true",
      ...
      previous={{ title: "Code Generator", href: "/docs/components/code-generator" }}
