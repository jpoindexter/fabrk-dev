    ...
    <Card tone="neutral">
      ...
      <CardContent padding="md">
        ...
        <div className={cn(mode.font, 'space-y-2 text-xs')}>
          <div>
            <span className="text-success">&gt;</span> 3-tab navigation
            (Overview, Plans & Pricing, Billing History)
          </div>
          <div>
            <span className="text-success">&gt;</span> Current subscription card
            with plan details and features
          </div>
          <div>
            <span className="text-success">&gt;</span> Usage metrics with
            progress bars (team, storage, API calls)
          </div>
          <div>
            <span className="text-success">&gt;</span> Payment methods
            management (add, remove, set default)
          </div>
          <div>
            <span className="text-success">&gt;</span> Recent invoices preview
          ...
          <div>
            <span className="text-success">&gt;</span> Complete billing history
