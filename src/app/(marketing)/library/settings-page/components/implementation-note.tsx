    ...
    <CodeWindow filename="features.md">
      <div className="p-4">
        ...
        <div className={cn(mode.font, 'space-y-2 text-xs')}>
          ...
          <div>
            <span className="text-success">&gt;</span> Privacy controls (data
            sharing, cookies, analytics)
          </div>
          <div>
            <span className="text-success">&gt;</span> Data export functionality
          </div>
          <div>
            <span className="text-success">&gt;</span> Account profile form
            (name, email, company, bio)
          </div>
          <div>
            <span className="text-success">&gt;</span> Security settings
            (password, 2FA, sessions)
          </div>
          <div>
            <span className="text-success">&gt;</span> Subscription management
            (plan, billing cycle)
          </div>
          <div>
          ...
          <div>
            <span className="text-success">&gt;</span> Danger zone (account
            deletion)
          </div>
          <div>
        ...
        <div className={cn(mode.font, 'text-muted-foreground mt-4 text-xs')}>
          [NOTE]: Form components in src/components/settings/. Connect to your
