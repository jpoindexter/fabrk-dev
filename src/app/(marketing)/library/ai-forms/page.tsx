...
export default function AIFormGeneratorTemplate() {
  return (
    <TemplateShowcasePage
      ...
      code={templateCode}
      fileStructure={[
        { path: ['app/', 'api/ai/', 'generate-form/route.ts'], label: '← AI endpoint' },
        { path: ['app/', '(tools)/', 'ai-forms/page.tsx'], label: '← Copy template here' },
        { path: ['components/', 'ai/', 'chat-interface.tsx'] },
        { path: ['components/', 'ai/', 'form-preview.tsx'] },
        { path: ['components/', 'ai/', 'code-viewer.tsx'] },
