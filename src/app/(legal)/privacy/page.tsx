    ...
    <main className="container mx-auto max-w-4xl px-6 py-16 font-mono">
      ...
      <div className="space-y-8">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">We use collected information for:</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">Under GDPR, we process your data based on:</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">We share data with trusted third parties:</p>
              <ul className="space-y-1 text-xs text-muted-foreground pl-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-3">We may disclose data if required by law:</p>
              <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">We implement industry-standard security measures:</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">We retain your data for:</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-2">Contact us at:</p>
              <ul className="space-y-1 text-xs text-muted-foreground pl-4">
                <li>├─ EMAIL: privacy@fabrk.dev</li>
                <li>└─ SETTINGS: <Link href="/settings" className="text-primary hover:underline">/settings</Link></li>
              </ul>
              <p className="text-xs text-muted-foreground mt-2">Response time: 30 days</p>
            </div>
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">We use cookies for:</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
        ...
        <section className="border border-border bg-card p-6">
          ...
          <p className="text-xs text-muted-foreground mb-3">Privacy questions or concerns?</p>
          <ul className="space-y-1 text-xs text-muted-foreground pl-4">
