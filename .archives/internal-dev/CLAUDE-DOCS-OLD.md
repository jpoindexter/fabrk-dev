...
**20 Color Themes** (switchable via `/components` page):
...
Templates live under `/library` and are documented in `src/app/library/README.md`. Each template is self-contained and can be copied into a production app.
