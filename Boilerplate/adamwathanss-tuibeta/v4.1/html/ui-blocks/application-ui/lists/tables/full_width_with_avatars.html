        ...
        <tr v-for="item in activityItems" :key="item.commit">
          <td class="py-4 pr-8 pl-4 sm:pl-6 lg:pl-8">
            <div class="flex items-center gap-x-4">
              <img :src="item.user.imageUrl" alt="" class="size-8 rounded-full bg-gray-800 outline outline-white/10" />
          ...
          <td class="hidden py-4 pr-4 pl-0 sm:table-cell sm:pr-8">
            <div class="flex gap-x-3">
              ...
              <div class="rounded-md bg-gray-700/40 px-2 py-1 text-xs font-medium text-gray-400 outline-1 -outline-offset-1 outline-white/10">{{ item.branch }}</div>
            </div>
          </td>
