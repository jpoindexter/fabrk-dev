<template>
  ...
  <div class="pointer-events-none fixed inset-x-0 bottom-0 sm:px-6 sm:pb-5 lg:px-8">
    <div class="pointer-events-auto flex items-center justify-between gap-x-6 bg-gray-800 px-6 py-2.5 inset-ring inset-ring-white/10 sm:rounded-xl sm:py-3 sm:pr-3.5 sm:pl-4">
