<template>
  <div class="relative flex items-center gap-x-6 bg-gray-800 px-6 py-2.5 after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
