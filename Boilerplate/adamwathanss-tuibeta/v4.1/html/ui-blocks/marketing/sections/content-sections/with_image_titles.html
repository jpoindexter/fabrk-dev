  ...
  <div class="overflow-hidden bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <div class="max-w-4xl">
        ...
        <p class="mt-6 text-xl/8 text-balance text-gray-300">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas.</p>
      </div>
      <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
        <div class="lg:pr-8">
          <h2 class="text-2xl font-semibold tracking-tight text-pretty text-white">Our mission</h2>
        ...
        <div class="pt-16 lg:row-span-2 lg:-mr-16 xl:mr-auto">
          <div class="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 xl:gap-8">
            <div class="aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-white/10">
            ...
            <div class="-mt-8 aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-white/10 lg:-mt-40">
