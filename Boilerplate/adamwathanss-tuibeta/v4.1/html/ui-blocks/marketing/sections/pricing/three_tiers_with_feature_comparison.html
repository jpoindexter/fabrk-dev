    ...
    <div class="flow-root border-b border-b-white/5 bg-gray-800/25 pt-24 pb-16 sm:pt-32 lg:pb-0">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
          ...
          <div v-for="tier in tiers" :key="tier.id" :class="[tier.featured ? 'z-10 bg-gray-800 outline-1 -outline-offset-1 outline-white/10' : 'bg-gray-800/80 outline-1 -outline-offset-1 outline-white/10 lg:bg-transparent lg:pb-14 lg:outline-0', 'group/tier relative rounded-2xl']" :data-featured="tier.featured ? 'true' : undefined">
