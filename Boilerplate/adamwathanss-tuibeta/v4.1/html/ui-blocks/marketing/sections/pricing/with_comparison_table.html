  ...
  <div class="bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
        <section v-for="tier in tiers" :key="tier.id" :class="[tier.mostPopular ? 'rounded-xl bg-white/5 inset-ring inset-ring-white/10' : '', 'p-8']">
            ...
            <tbody>
              <tr>
                ...
                <td v-for="tier in tiers" :key="tier.id" class="px-6 pt-2 xl:px-8">
                  ...
                  <a :href="tier.href" :class="[tier.mostPopular ? 'bg-indigo-500 text-white hover:bg-indigo-400' : 'bg-white/10 text-white inset-ring inset-ring-white/5 hover:bg-white/20 focus-visible:outline-white/75', 'mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500']">Buy plan</a>
                </td>
              </tr>
