          ...
          <table class="relative min-w-full divide-y divide-white/15">
            ...
            <tbody class="divide-y divide-white/10 bg-gray-900">
              <tr v-for="person in people" :key="person.email">
                <td class="py-5 pr-3 pl-4 text-sm whitespace-nowrap sm:pl-0">
                  <div class="flex items-center">
                    <div class="size-11 shrink-0">
                      <img class="size-11 rounded-full outline outline-white/10" :src="person.image" alt="" />
                    </div>
                    <div class="ml-4">
                ...
                <td class="px-3 py-5 text-sm whitespace-nowrap text-gray-400">
                  <span class="inline-flex items-center rounded-md bg-green-900/30 px-2 py-1 text-xs font-medium text-green-400 ring-1 ring-green-500/50 ring-inset">Active</span>
                </td>
                <td class="px-3 py-5 text-sm whitespace-nowrap text-gray-400">{{ person.role }}</td>
