      ...
      <table class="min-w-full divide-y divide-white/15">
        ...
        <tbody class="divide-y divide-white/10 bg-gray-900">
          <tr v-for="person in people" :key="person.email">
            ...
            <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-400 sm:table-cell">{{ person.title }}</td>
            <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-400 lg:table-cell">{{ person.email }}</td>
