      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:ml-4 md:flex md:items-center">
          <Menu as="div" class="relative">
            ...
            <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform scale-100" leave-to-class="transform opacity-0 scale-95">
              <MenuItems class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-gray-800 outline-1 -outline-offset-1 outline-white/5">
                <div class="py-1">
        ...
        <div class="ml-6 md:hidden">
          <Menu as="div" class="relative">
            ...
            <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform scale-100" leave-to-class="transform opacity-0 scale-95">
              <MenuItems class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-white/10 overflow-hidden rounded-md bg-gray-800 shadow-lg outline-1 -outline-offset-1 outline-white/5">
                <div class="py-1">
                  <MenuItem v-slot="{ active }">
      ...
      <div class="mx-auto grid max-w-3xl grid-cols-1 gap-x-8 gap-y-16 px-4 py-16 sm:grid-cols-2 sm:px-6 xl:max-w-none xl:grid-cols-3 xl:px-8 2xl:grid-cols-4">
        <section v-for="month in months" :key="month.name" class="text-center">
          ...
          <div class="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-white/10 text-sm ring-1 ring-white/10">
            <button v-for="day in month.days" :key="day.date" type="button" :data-is-current-month="day.isCurrentMonth ? '' : undefined" :data-is-today="day.isToday ? '' : undefined" class="relative bg-gray-900/75 py-1.5 text-gray-500 first:rounded-tl-lg last:rounded-br-lg hover:bg-gray-900/25 focus:z-10 data-is-current-month:bg-gray-900 data-is-current-month:text-gray-100 data-is-current-month:hover:bg-gray-900/50 nth-36:rounded-bl-lg nth-7:rounded-tr-lg">
              <time :datetime="day.date" class="mx-auto flex size-7 items-center justify-center rounded-full in-data-is-today:bg-indigo-500 in-data-is-today:font-semibold in-data-is-today:text-white">{{ day.date.split('-').pop().replace(/^0/, '') }}</time>
            </button>
          </div>
        </section>
      </div>
