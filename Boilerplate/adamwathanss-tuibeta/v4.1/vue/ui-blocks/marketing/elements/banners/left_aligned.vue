<template>
  <div class="relative flex items-center justify-between gap-x-6 bg-gray-800 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:pr-3.5 lg:pl-8">
