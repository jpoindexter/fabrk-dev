<template>
  ...
  <div class="fixed inset-x-0 bottom-0">
    <div class="flex items-center gap-x-6 bg-gray-800 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
