  ...
  <div class="bg-gray-900 py-16 sm:py-24 lg:py-32">
    <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
      ...
      <form class="w-full max-w-md lg:col-span-5 lg:pt-2">
        ...
        <p class="mt-4 text-sm/6 text-gray-300">We care about your data. Read our <a href="#" class="font-semibold whitespace-nowrap text-indigo-400 hover:text-indigo-300">privacy policy</a>.</p>
      </form>
    </div>
  </div>
</template>
